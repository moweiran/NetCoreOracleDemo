...
{
    public partial class FF_AIR_ORDER_BL
    {
        public decimal FF_AIR_ORDER_BL_ID { get; set; }
        public decimal FF_AIR_ORDER_ID { get; set; }
        public decimal MAIN_AIR_ORDER_ID { get; set; }
