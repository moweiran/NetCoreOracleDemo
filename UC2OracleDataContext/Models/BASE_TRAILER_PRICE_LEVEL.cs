...
{
    public partial class BASE_TRAILER_PRICE_LEVEL
    {
        public BASE_TRAILER_PRICE_LEVEL()
        {
            BASE_TRAIL_PRICE_LEV_DET = new HashSet<BASE_TRAIL_PRICE_LEV_DET>();
        }

        public decimal BASE_TRAILER_PRICE_LEVEL_ID { get; set; }
        ...
        public decimal GP20_LOWER_DOUBLE { get; set; }
        public decimal GP20_UPPER_DOUBLE { get; set; }
        ...
        public virtual ICollection<BASE_TRAIL_PRICE_LEV_DET> BASE_TRAIL_PRICE_LEV_DET { get; set; }
    }
}
