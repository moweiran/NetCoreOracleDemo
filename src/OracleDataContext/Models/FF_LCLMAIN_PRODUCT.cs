...
{
    public partial class FF_LCLMAIN_PRODUCT
    {
        public FF_LCLMAIN_PRODUCT()
        {
            FF_LCLMAIN_PRODUCT_LEVELs = new HashSet<FF_LCLMAIN_PRODUCT_LEVEL>();
        }
        ...
        public virtual ICollection<FF_LCLMAIN_PRODUCT_LEVEL> FF_LCLMAIN_PRODUCT_LEVELs { get; set; }
    }
}
